...
class NEOChatModel(PreTrainedModel):
    ...
    def __init__(self, config: NEOChatConfig, vision_model=None, language_model=None, use_flash_attn=True):
        ...
        # transformers 5.x: post_init() populates all_tied_weights_keys,
        # _tp_plan, _no_split_modules, etc. that from_pretrained reads during
        # weight loading. Not called in the vendored 4.5x source.
        self.post_init()
