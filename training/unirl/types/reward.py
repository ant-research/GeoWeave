...
class RewardResponse(Batch):
    ...
    # Optional sample-aligned structured process judgments (for example SCA
    # step spans and GenPRM votes). Scalar-only reward backends leave it empty.
    process_annotations: List[Optional[Dict[str, Any]]] = concat_field(default_factory=list)
