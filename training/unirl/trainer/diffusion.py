...
class DiffusionTrainer(BaseTrainer):
    ...
    def train_step(
        ...
        *,
        ...
        self.metric_logger.log_rollout_step(rollout_id, result, resp, step_time_s=time.perf_counter() - t0)
    ...
    def evaluate(self, step: int) -> float:
        ...
        self.metric_logger.log_eval(step, {"reward": mean_reward})
        return mean_reward
        ...
        *,
        ...
        try:
            ...
            for rollout_id in range(start_rollout, num_rollouts):
                ...
                self.metric_logger.log_progress(rollout_id, num_rollouts, result, mean_reward, logger=logger)
